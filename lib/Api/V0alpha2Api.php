...
class V0alpha2Api
{
    ...
    public function adminDeleteIdentitySessionsRequest($id)
    {
        ...
        $resourcePath = '/identities/{id}/sessions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function adminListIdentitiesRequest($perPage = 100, $page = 0)
    {
        if ($perPage !== null && $perPage > 500) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling V0alpha2Api.adminListIdentities, must be smaller than or equal to 500.');
        }
     ...
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Kratos\Client\Model\SelfServiceSettingsFlow|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError
     */
     ...
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Kratos\Client\Model\SelfServiceSettingsFlow|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Kratos\Client\Model\IdentitySchema[]|\Ory\Kratos\Client\Model\JsonError
     */
    public function listIdentitySchemas($perPage = 100, $page = 0)
    {
     ...
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Kratos\Client\Model\IdentitySchema[]|\Ory\Kratos\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
    public function listIdentitySchemasWithHttpInfo($perPage = 100, $page = 0)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ory\Kratos\Client\Model\IdentitySchema[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ory\Kratos\Client\Model\IdentitySchema[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 500:
            ...
            $returnType = '\Ory\Kratos\Client\Model\IdentitySchema[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ory\Kratos\Client\Model\IdentitySchema[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIdentitySchemasAsync($perPage = 100, $page = 0)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIdentitySchemasAsyncWithHttpInfo($perPage = 100, $page = 0)
    {
        $returnType = '\Ory\Kratos\Client\Model\IdentitySchema[]';
        $request = $this->listIdentitySchemasRequest($perPage, $page);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listIdentitySchemasRequest($perPage = 100, $page = 0)
    {
        if ($perPage !== null && $perPage > 500) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling V0alpha2Api.listIdentitySchemas, must be smaller than or equal to 500.');
        }
        if ($perPage !== null && $perPage < 1) {
     ...
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Kratos\Client\Model\SuccessfulSelfServiceLoginWithoutBrowser|\Ory\Kratos\Client\Model\SelfServiceLoginFlow|\Ory\Kratos\Client\Model\SelfServiceBrowserLocationChangeRequiredError|\Ory\Kratos\Client\Model\JsonError
     */
     ...
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Kratos\Client\Model\SuccessfulSelfServiceLoginWithoutBrowser|\Ory\Kratos\Client\Model\SelfServiceLoginFlow|\Ory\Kratos\Client\Model\SelfServiceBrowserLocationChangeRequiredError|\Ory\Kratos\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitSelfServiceLoginFlowWithHttpInfo($flow, $xSessionToken = null, $submitSelfServiceLoginFlowBody = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 422:
                    if ('\Ory\Kratos\Client\Model\SelfServiceBrowserLocationChangeRequiredError' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ory\Kratos\Client\Model\SelfServiceBrowserLocationChangeRequiredError', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 500:
            ...
            switch ($e->getCode()) {
                ...
                case 422:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ory\Kratos\Client\Model\SelfServiceBrowserLocationChangeRequiredError',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Kratos\Client\Model\SuccessfulSelfServiceRegistrationWithoutBrowser|\Ory\Kratos\Client\Model\SelfServiceRegistrationFlow|\Ory\Kratos\Client\Model\SelfServiceBrowserLocationChangeRequiredError|\Ory\Kratos\Client\Model\JsonError
     */
     ...
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Kratos\Client\Model\SuccessfulSelfServiceRegistrationWithoutBrowser|\Ory\Kratos\Client\Model\SelfServiceRegistrationFlow|\Ory\Kratos\Client\Model\SelfServiceBrowserLocationChangeRequiredError|\Ory\Kratos\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Kratos\Client\Model\SelfServiceSettingsFlow|\Ory\Kratos\Client\Model\SelfServiceSettingsFlow|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\SelfServiceBrowserLocationChangeRequiredError|\Ory\Kratos\Client\Model\JsonError
     */
     ...
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Kratos\Client\Model\Session|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError
     */
     ...
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Kratos\Client\Model\Session|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
